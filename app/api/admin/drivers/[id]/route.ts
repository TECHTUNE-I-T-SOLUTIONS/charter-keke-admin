    ...
    return NextResponse.json(
      {
        driver: {
          ...
          identity_type: driver.identity_type || "",
          nin_number: driver.nin_number || "",
          identity_last4: driver.identity_last4 || "",
          identity_document_url: driver.identity_document_url || "",
          identity_verified: !!driver.identity_verified,
          identity_verification_status: driver.identity_verification_status || "not_started",
          identity_verification_provider: driver.identity_verification_provider || "",
          identity_verification_reason: driver.identity_verification_reason || "",
