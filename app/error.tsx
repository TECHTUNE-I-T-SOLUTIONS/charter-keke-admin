...
Stack: ${error.stack || "Not available"}`}
              ...
              <div className="p-4 rounded-lg bg-blue-500/5 border border-blue-500/20 space-y-2">
                <p className="text-sm font-medium text-blue-600 dark:text-blue-400">💡 Try these:</p>
            ...
            <div className="text-xs text-muted-foreground text-center space-y-1">
              <p>Need assistance? <Link href="/help" className="text-primary hover:underline font-medium">Contact Support</Link></p>
              {error.digest && (
