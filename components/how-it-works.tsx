          ...
          {steps.map((step, index) => (
            <div key={step.title} className="relative group">
              ...
              {index < steps.length - 1 && (
                <div className="hidden lg:block absolute top-12 left-1/2 w-full h-0.5 bg-gradient-to-r from-[#b8507b] to-[#4353a4] opacity-20" />
              )}
              ...
              <div className="relative z-10 p-6 rounded-2xl bg-card border border-border hover:border-primary/50 transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#b8507b] to-[#4353a4] flex items-center justify-center mb-4 text-white">
                  <step.icon className="h-6 w-6" />
                </div>
                <div className="absolute -top-3 -right-3 w-8 h-8 rounded-full bg-gradient-to-br from-[#b8507b] to-[#4353a4] flex items-center justify-center text-white font-bold text-sm">
                  {index + 1}
                </div>
