      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            About{" "}
            <span className="bg-gradient-to-r from-[#744200] to-[#9E5A00] bg-clip-text text-transparent dark:bg-gradient-to-r dark:from-[#F8CF9A] dark:to-[#F5DAB7]">Charter Keke</span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 text-center justify-center">
          {values.map((value) => (
            ...
            >
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#AF6401] to-[#EE8906] flex items-center justify-center mb-4 text-white group-hover:scale-110 transition-transform mx-auto">
        ...
        <div className="mt-16 p-8 rounded-2xl bg-gradient-to-r from-[#AF6401]/10 to-[#EE8906]/10 border border-primary/20">
